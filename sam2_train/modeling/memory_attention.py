...
class MemoryAttention(nn.Module):
    def __init__(
        ...
        self.context_layers = get_clones(layer, 1)
        self.mem_proj = nn.Conv2d(256, 256, kernel_size=2, stride=2, padding=0)
