...
class SAM2Base(torch.nn.Module):
    ...
    def forward_image(self, img_batch: torch.Tensor, point_features: List[torch.Tensor]):
        """Get the image feature on the input batch."""
        backbone_out,point_features = self.image_encoder(img_batch, point_features)
        ...
        return backbone_out,point_features
